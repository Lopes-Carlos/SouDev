  		...
  		<body class='d-flex h-100 text-center text-white bg-dark'>
			<div class='cover-container d-flex w-100 h-100 p-3 mx-auto flex-column'>
  				<header class='mb-auto'>
  					<div>
      					<h3 class='color_white float-md-start mb-0 text-4'> $nome_do_site</h3>
				...
				<p class='lead'>
				<b href='#' class='btn btn-lg btn-secondary fw-bold border-white bg-white'>Error: $this->nome_bd_conectar</b>
				</p>
				</main>";
				}
				...
				echo "
  				...
  				<div class='col d-flex text-secondary justify-content-center'>
  				 $rdp_1_titulo <a href='$rdp_3_titulo' target='_blank'>&nbsp;$rdp_2_titulo</a>
  				</div>
  				</div>
  				</footer>
			</div>
